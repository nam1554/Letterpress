...
- Iteration budget: if the SAME band still fails verification after 2
  ...
  or transparent text does not count, whether hidden inline or via CSS class),
  rejects any image wider than 400px with an aspect ratio taller than 2:1 as a
  page screenshot, and rejects deliverables whose full-width images cover more
  than 70% of the email's height in total (a sliced screenshot). Build the
  sections for real — there is no shortcut past this gate.
